...
const Notifications = () => {
  ...
  const { notifications, unreadCount } = useNotifications(); // ✅ Fetch real-time notifications
...
//         <MdOutlineNotificationsActive className="text-xl text-gray-600 dark:text-gray-300" />
//         {unreadCount > 0 && (
//           <span className="absolute -top-1 -right-1.5 bg-redAccent-900 text-white text-xs px-1.5 py-0.5 rounded-full">
//             {unreadCount}
//           </span>
//         )}
//       </DialogTrigger>
